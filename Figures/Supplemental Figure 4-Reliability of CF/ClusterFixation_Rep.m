function [fixationstats] = ClusterFixation_Rep(eyedat,samprate,rep)
...
% Same as cluster Fixation/Cluster Fix just allows you to adjust the number
% of replications for kmeans. Rep is the # of replications.
